...
*/
int XT_REMOTE_EXPORT read_profile_string( const char *section, const char *key,char *value, 
...
*/
int XT_REMOTE_EXPORT read_profile_int( const char *section, const char *key,int default_value, 
				const char *file)
{
	char value[32] = {0};
 ...
 * @return 1 : success\n 0 : failure
 */
int  XT_REMOTE_EXPORT write_profile_string(const char *section, const char *key,
